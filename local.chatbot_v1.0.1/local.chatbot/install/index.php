...
class local_chatbot extends CModule
{
    var $MODULE_ID = "local.chatbot";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = "Локальная отправка сообщений чат-бота";
        $this->MODULE_DESCRIPTION = "Позволяет отправлять сообщения из чат-бота напрямую, не используя сервер oauth.bitrix.info";
    }
